...
//                Toast.makeText(getApplicationContext(),String.valueOf(SetList.size()), Toast.LENGTH_SHORT).show();
                ...
                setlist_adapter Set_Adapter_myset = new setlist_adapter(setlist_main.this.getApplicationContext(), SetList,setlist_main.this);
                LinearLayoutManager linearLayoutManager_myset = new LinearLayoutManager(setlist_main.this.getApplicationContext(),RecyclerView.VERTICAL,false);
